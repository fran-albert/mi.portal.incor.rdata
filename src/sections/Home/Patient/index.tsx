      ...
      <section className="container mx-auto py-12 px-4 md:py-16 md:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
          <div className="space-y-4">
            <h1 className="text-3xl font-bold tracking-tighter text-incor sm:text-4xl md:text-5xl">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <Card className="flex flex-col items-start justify-between gap-4 rounded-lg border bg-card p-4 shadow-sm">
                <div>
                  <UserIcon className="h-8 w-8 text-incor" />
                ...
                <Button variant="link" size="sm">
                  <Link href={"/mi-perfil"}>Ir a Perfil</Link>
                </Button>
              </Card>
              <Card className="flex flex-col items-start justify-between gap-4 rounded-lg border bg-card p-4 shadow-sm">
                <div>
                  <FileTextIcon className="h-8 w-8 text-incor" />
                  <h3 className="mt-2 text-lg font-medium">
                ...
                <Button variant="link" size="sm">
                  <Link href={"/mis-estudios"}>Ver</Link>
                </Button>
              </Card>
            </div>
          </div>
