import { getHealthInsurances } from "@/actions/Health-Insurance/get-all-health-insurances.action";
import { getTotalHealthInsurances } from "@/actions/Health-Insurance/get-total-health-insurances.action";
