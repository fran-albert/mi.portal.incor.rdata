import { getSpecialities } from "@/actions/Speciality/get-all-specialities.action";
import { getTotalSpecialities } from "@/actions/Speciality/get-total-specialities.action";
