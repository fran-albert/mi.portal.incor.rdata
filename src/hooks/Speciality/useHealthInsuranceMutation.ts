import { createSpeciality } from "@/actions/Speciality/create-speciality.action";
import { deleteSpeciality } from "@/actions/Speciality/delete-speciality.action";
import { updateSpeciality } from "@/actions/Speciality/update-patient.action";
